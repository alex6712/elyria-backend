...
@elyria_backend.exception_handler(CoupleNotSelfException)
...
@elyria_backend.exception_handler(IncorrectPasswordException)
...
@elyria_backend.exception_handler(NewPasswordSameAsOldException)
...
@elyria_backend.exception_handler(NothingToUpdateException)
...
@elyria_backend.exception_handler(UnsupportedFileTypeException)
