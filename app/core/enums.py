...
class DeleteErrorCode(StrEnum):
    """Класс-перечисление кодов ошибок при удалении сущностей.

    Определяет все возможные причины, по которым операция удаления
    может завершиться неудачей.

    Attributes
    ----------
    NOT_FOUND
        Сущность не найдена или недоступна для удаления.
    """

    NOT_FOUND = "NOT_FOUND"
    """Запрашиваемая сущность не найдена в системе либо недоступна текущему пользователю."""
