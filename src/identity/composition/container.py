...
class IdentityContainer:
    """Контейнер Use Case контекста Identity.
...
def build_identity_module(
    *,
    ...
    """Собрать модуль Identity: контейнер Use Cases с реализациями портов.

    Единственная точка сборки Identity в границах его ограниченного
    ...
    -------
    IdentityContainer
        Контейнер фабрик Use Cases контекста Identity.
